...
import { McpServer } from "@modelcontextprotocol/sdk/server/mcp.js";
	...
	server.registerTool( 'create_match_event', {
		...
		if (supportsFormElicitation) {
			...
			team = elicitation.content.favoriteTeam as string;
			recipientEmail = elicitation.content.email as string;
			reminderMinutes = elicitation.content.reminderMinutes as number;
		} else {
